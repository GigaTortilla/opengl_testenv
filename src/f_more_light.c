...
void mouseCallbackMoreLight(GLFWwindow* window, double xPos, double yPos);
void scrollCallbackMoreLight(GLFWwindow* window, double xoffset, double yoffset);
...
int f_more_light()
{
	...
	glfwSetCursorPosCallback(window, mouseCallbackMoreLight);
	glfwSetScrollCallback(window, scrollCallbackMoreLight);
